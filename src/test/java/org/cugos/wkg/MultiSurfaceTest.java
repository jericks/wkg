...
public class MultiSurfaceTest {
    ...
    public void create() {
        MultiSurface multiSurface = new MultiSurface(
            Arrays.<Surface>asList(
                new CurvePolygon(
                    new CircularString(
                        Arrays.asList(
                            Coordinate.create2D(0,0),
                            Coordinate.create2D(4,0),
                            Coordinate.create2D(4,4),
                            Coordinate.create2D(0,4),
                            Coordinate.create2D(0,0)
                        ),
                        Dimension.Two
                    ),
                    Arrays.<Curve>asList(
                        new LineString(Arrays.asList(
                            ...
                            Coordinate.create2D(3,3),
                            Coordinate.create2D(3,1),
                            Coordinate.create2D(1,1)
                        ), Dimension.Two)
                    ),
                    Dimension.Two
                ...
                new Polygon(
                    new LinearRing(
                        Arrays.asList(
                            ...
                            Coordinate.create2D(14,12),
                            Coordinate.create2D(11,10),
                            Coordinate.create2D(10,10)
                        ),
                        Dimension.Two
                    ),
                    Arrays.asList(
                        new LinearRing(
                            Arrays.asList(
                                Coordinate.create2D(11,11),
                                Coordinate.create2D(11.5,11),
                                Coordinate.create2D(11,11.5),
                                Coordinate.create2D(11,11)
                            ),
                            Dimension.Two
                        )
        ...
        assertEquals("MULTISURFACE (CURVEPOLYGON (CIRCULARSTRING (0.0 0.0, 4.0 0.0, 4.0 4.0, 0.0 4.0, 0.0 0.0), (1.0 1.0, 3.0 3.0, 3.0 1.0, 1.0 1.0)), ((10.0 10.0, 14.0 12.0, 11.0 10.0, 10.0 10.0), (11.0 11.0, 11.5 11.0, 11.0 11.5, 11.0 11.0)))", multiSurface.toString());
        assertEquals(Dimension.Two, multiSurface.getDimension());
        assertNull(multiSurface.getSrid());
    }

    @Test
    public void createEmpty() {
        MultiSurface ms = MultiSurface.createEmpty();
    ...
    public void empty() {
        ...
        Geometry geometry = reader.read("MULTISURFACE EMPTY");
