...
public class PolygonTest {
    ...
    public void empty() {
        ...
        Geometry geometry = reader.read("POLYGON EMPTY");
    ...
    public void twoDimensional() {
        WKTReader reader = new WKTReader();
        Geometry geometry = reader.read("POLYGON ((30 10, 40 40, 20 40, 10 20, 30 10))");
    ...
    public void twoDimensionalWithSrid() {
        WKTReader reader = new WKTReader();
        Geometry geometry = reader.read("SRID=4326;POLYGON ((30 10, 40 40, 20 40, 10 20, 30 10))");
    ...
    public void twoDimensionalMeasured() {
        WKTReader reader = new WKTReader();
        Geometry geometry = reader.read("POLYGON M ((30 10 1, 40 40 2, 20 40 3, 10 20 4, 30 10 1))");
    ...
    public void threeDimensional() {
        WKTReader reader = new WKTReader();
        Geometry geometry = reader.read("POLYGON Z ((30 10 1, 40 40 2, 20 40 3, 10 20 4, 30 10 1))");
    ...
    public void threeDimensionalMeasured() {
        WKTReader reader = new WKTReader();
        Geometry geometry = reader.read("POLYGON ZM ((30 10 1 2, 40 40 2 4, 20 40 3 5, 10 20 4 6, 30 10 1 2))");
