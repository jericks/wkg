...
public class PolyHedralSurfaceTest {
    ...
    public void createEmpty() {
        PolyHedralSurface phs = PolyHedralSurface.createEmpty();
    ...
    public void empty() {
        ...
        Geometry geometry = reader.read("POLYHEDRALSURFACE EMPTY");
    ...
    public void twoDimensional() {
        WKTReader reader = new WKTReader();
        Geometry geometry = reader.read("POLYHEDRALSURFACE (" +
    ...
    public void twoDimensionalWithSrid() {
        WKTReader reader = new WKTReader();
        Geometry geometry = reader.read("SRID=4326;POLYHEDRALSURFACE (" +
                        "((40 40, 20 45, 45 30, 40 40))," +
                        "((20 35, 10 30, 10 10, 30 5, 45 20, 20 35),(30 20, 20 15, 20 25, 30 20))" +
                        ")");
    ...
    public void twoDimensionalMeasured() {
        WKTReader reader = new WKTReader();
        Geometry geometry = reader.read("POLYHEDRALSURFACE M (" +
    ...
    public void threeDimensional() {
        WKTReader reader = new WKTReader();
        Geometry geometry = reader.read("POLYHEDRALSURFACE Z (" +
                        "((40 40 1, 20 45 2, 45 30 3, 40 40 1))," +
                        "((20 35 1, 10 30 2, 10 10 3, 30 5 4, 45 20 5, 20 35 1),(30 20 1, 20 15 2, 20 25 3, 30 20 1))" +
                        ")");
    ...
    public void threeDimensionalMeasured() {
        WKTReader reader = new WKTReader();
        Geometry geometry = reader.read("POLYHEDRALSURFACE ZM (" +
